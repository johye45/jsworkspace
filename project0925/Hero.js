...
class Hero{
    ...
    //특히 생성자 메서드라 부른다
    //아래의 생성자함수를 호출하는자는, 반드시 주인공 이미지가 붙게될
    //부모 요소를 전달해야 한다 container변수로
    constructor(container,x,y,width,height){
        //constructor안에 선언된 변수는 현재 인스턴스 꺼다
        //this 가 붙어있는 변수는, 해당 인스턴스와 생명력을 같이한다.
        //즉 해당 인스턴스 마다 각각 고유하게 보유할 수 있는 변수
        //언제 소멸되냐, 인스턴스가 살아있는 한
        this.x=x;
        this.y=y
